...
PacketHandler.prototype.handshake_onCompleted = function (protocol, key) {
    ...
    this.sendPacket(new Packet.SetBorder(this.socket.playerTracker, this.gameServer.border, this.gameServer.config.serverGamemode, this.gameServer.config.serverName + ' ' + this.gameServer.version));
    // Send welcome message
    this.gameServer.sendChatMessage(null, this.socket.playerTracker, this.gameServer.config.serverName + ' ' + this.gameServer.version);
