...
import sprites   from '../../../app/js/sprites';
...
BotLoader.prototype.loadNames = function () {
  ...
  if (fs.existsSync(`${__dirname}/BotNames.txt`)) {
...
BotLoader.prototype.addBot = function () {
  ...
  s.playerTracker.setSkin(Util.randomProperty(sprites));
};
